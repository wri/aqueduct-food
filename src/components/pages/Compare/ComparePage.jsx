...
export default function ComparePage(props) {
  ...
  if (!showWidgetInfo) {
    toastr.info('Note that widgets are not always limited to the current selection and can contain information about irrigated, '
      + 'rained and total agriculture as well as various indicators and timeframes.', {
